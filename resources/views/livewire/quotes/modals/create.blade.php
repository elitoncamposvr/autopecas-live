<div class="fixed inset-0 bg-gray-900/50 flex items-center justify-center z-50">
    <div class="bg-white rounded-lg shadow-lg w-full max-w-lg p-6">
        <h2 class="text-lg font-semibold mb-4 text-gray-700">New Item</h2>
        ...
        <form wire:submit.prevent="saveItem" class="space-y-3">
            ...
            <div class="flex justify-end mt-4 space-x-3">
                <button type="button" wire:click="$set('showCreateModal', false)" class="px-3 py-2 bg-gray-200 text-gray-800 rounded-md text-sm hover:bg-gray-300">
                    Cancel
                </button>
